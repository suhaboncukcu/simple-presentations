...
class SlidesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'presentation_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'presentation_id' => 1,
                'template_id' => 1,
                'created' => '2018-10-10 12:48:34',
                'modified' => '2018-10-10 12:48:34'
            ],
        ];
        parent::init();
    }
